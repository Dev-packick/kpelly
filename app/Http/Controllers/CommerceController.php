...
class CommerceController extends Controller
{
    ...
    public function store_vente(Request $request)
    {
      $this->validate($request, [
          ...
          'prix_produit' => 'nullable|string', // Nullable et doit être une chaîne si fourni
          'descript_produit' => 'required|string',
          'idCategorie' => 'required|exists:categories,id',
          'idTaille' => 'nullable|string', // Nullable et doit être une chaîne si fourni
          'idCouleur' => 'nullable|string', // Nullable et doit être une chaîne si fourni
