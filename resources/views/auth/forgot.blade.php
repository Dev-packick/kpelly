                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
									<div class="text-center mb-3">
										<a href="{{ asset ('client/assets/TABLEAU')}}">
										...
										<svg class="page-logo ms-2" width="110" height="33" viewBox="0 0 110 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <form action="#">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" value="mail@gmail.com">
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-primary btn-block">Validé</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
